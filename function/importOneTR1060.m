...
%sanitize TR1060 filename to create valid variable name in the workspace
[PATHSTR,tempVarName,EXT]=fileparts(FILENAME);
if isempty(strfind(upper(tempVarName),'TR1060'))
    tempVarName=strcat('TR1060_',tempVarName);
end
