%select file
[FILENAME, PATHNAME, FILTERINDEX] = uigetfile('*.cnv', 'Choose SBE37 files:','MultiSelect','on');
...
for ii=1:length(FILENAME)
    ...
    if notLoaded
        ...
        sample_data{ii+iend} = SBE37SMParse( {fullfile(PATHNAME,FILENAME{ii})}, 'timeseries' );
    else
