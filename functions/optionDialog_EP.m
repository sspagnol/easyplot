function [idx, choice] = optionDialog_EP( title, message, options, default )
%OPTIONDIALOG_EP Prompts the user to select an item from a drop down list of 
% options.
%
% Displays a dialog allowing the user to select from a drop down list of
% optiowns. Modified from optionDialog.m
%
% Inputs:
